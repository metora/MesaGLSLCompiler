...
void* GetAddressFromBase(const char* _pcFuinctionName)
{
    return NULL;
}
...
VkResult VulkanExampleBase::createInstance(bool enableValidation)
{
	...
	if (enableValidation && vkDebug::kValidationLayers.size ())
	{
		instanceCreateInfo.enabledLayerCount = vkDebug::kValidationLayers.size ();
		instanceCreateInfo.ppEnabledLayerNames = &vkDebug::kValidationLayers[0];
	}
