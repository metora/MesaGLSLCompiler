...
public:
	...
	void preparePipelines()
	{
		...
		shaderStages[0] = loadShaderGLSL("./../data/shaders/triangle150.vert", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShaderGLSL("./../data/shaders/triangle150.frag", VK_SHADER_STAGE_FRAGMENT_BIT);
